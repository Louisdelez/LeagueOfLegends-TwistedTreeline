...
fn main() {
    App::new()
        ...
        .configure_sets(
            Update,
            (GameSet::Input, GameSet::AI, GameSet::Movement, GameSet::Combat, GameSet::Spawn).chain(),
        )
        ...
        // === 3v3 BOT TEST ===
        .add_plugins(auto_test::AutoTestPlugin)
        .run();
}
